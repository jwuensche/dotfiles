  ...
  (setq-default
   ...
   '(
     ...
     (auto-completion :variables
                      auto-completion-tab-key-bahviour 'complete
...
values."
  ...
  (setq-default
   ...
   ;; the transparency level of a frame when it's acmyVSI1tive or selected.
...
you should place your code here."
  ...
  ; Use alternative line numbers mode
