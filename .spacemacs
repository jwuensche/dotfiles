...
values."
  (setq-default
   ...
   ;; variable `dotspacemacs-configuration-lazy-installation t
...
you should place your code here."
  ...
  ;Funny org mode config, kudos to fin
